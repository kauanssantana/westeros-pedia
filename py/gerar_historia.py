...
historia_westeros = [
    ...
    },
    {
        ...
        "descricao": "A justiça finalmente alcançou o sádico Joffrey. Durante o seu suntuoso banquete de casamento com Margaery Tyrell, o rei bebeu vinho envenenado com 'O Estrangulador'. Diante de toda a corte, o jovem tirano asfixiou-se até à morte, com o rosto roxo e a sangrar."
    },
    {
    ...
    },
    {
        "id": "morte-shireen",
        "ano": "302 d.C.",
        "titulo": "O Sacrifício de Shireen Baratheon",
        "foco": "O Preço do Trono",
        "imagem": "img/hist_shireen.jpg",
        "descricao": "Um dos momentos mais cruéis da guerra. Encurralado pelas nevascas mortais do Norte, Stannis Baratheon permitiu que a Sacerdotisa Vermelha Melisandre sacrificasse a sua única filha, a Princesa Shireen, nas chamas de uma pira. O ato visava aplacar o Senhor da Luz para derreter as neves e garantir a vitória, mas resultou apenas em tragédia, deserção e no fim da linhagem de Stannis."
    },
    {
        "id": "ressurreicao-jon",
        "ano": "302 d.C.",
...
print("historia.json forjado com sucesso! As 24 lendas essenciais da História foram registadas.")